...
use llama_cpp_rs::model::{LlamaChatMessage, LlamaChatTemplate, LlamaModel, Special};
        ...
        let mtmd_params = MtmdContextParams {
            ...
            media_marker: CString::new(
                params
                    .media_marker
                    .as_ref()
                    .unwrap_or(&llama_cpp_rs::mtmd::mtmd_default_marker().to_string())
                    .clone(),
            )?,
...
fn run_single_turn(
    ...
    let default_marker = llama_cpp_rs::mtmd::mtmd_default_marker().to_string();
