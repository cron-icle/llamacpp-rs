//! This is a translation of simple.cpp in llama.cpp using llama-cpp-rs.
#![allow(
...
use llama_cpp_rs::model::params::{LlamaModelParams, LlamaSplitMode};
use llama_cpp_rs::model::AddBos;
use llama_cpp_rs::model::LlamaModel;
use llama_cpp_rs::sampling::LlamaSampler;
use llama_cpp_rs::{ggml_time_us, send_logs_to_tracing, LogOptions};
...
enum Model {
    ...
    Local {
        /// The path to the model. e.g. `/home/user/.cache/huggingface/hub/models--TheBloke--Llama-2-7B-Chat-GGUF/blobs/08a5566d61d7cb6b420c3e4387a39e0078e1f2fe5f055f3a03887385304d4bfa`
        path: PathBuf,
    },
...
fn main() -> Result<()> {
    ...
    if list_devices {
        let devices = llama_cpp_rs::list_llama_ggml_backend_devices();
