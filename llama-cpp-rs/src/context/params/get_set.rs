...
impl LlamaContextParams {
    ...
    ///
    /// ```rust
    /// # use llama_cpp_rs::context::params::{LlamaContextParams, LlamaPoolingType};
    /// let params = LlamaContextParams::default()
    ...
    ///
    /// ```rust
    /// # use llama_cpp_rs::context::params::{LlamaContextParams, LlamaAttentionType};
    /// let params = LlamaContextParams::default()
    ...
    pub fn with_flash_attention_policy(
        mut self,
        policy: llama_cpp_rs_sys::llama_flash_attn_type,
    ) -> Self {
    ...
    #[must_use]
    pub fn flash_attention_policy(&self) -> llama_cpp_rs_sys::llama_flash_attn_type {
    ...
    ///
    /// ```rust
    /// # use llama_cpp_rs::context::params::{LlamaContextParams, KvCacheType};
